...
export default function ModularLoraResearch() {
  return (
    <div className="space-y-16">
      ...
      <section id="rq1">
        <SectionHeader eyebrow="RQ1 ·" title={researchQuestions[0]} />
      ...
      <section id="rq2">
        <SectionHeader eyebrow="RQ2 ·" title={researchQuestions[1]} />
        <div className="overflow-hidden rounded-2xl border bg-background">
          <div className="overflow-x-auto">
      ...
      <section id="rq3">
        <SectionHeader eyebrow="RQ3 ·" title={researchQuestions[2]} />
